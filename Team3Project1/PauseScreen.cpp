...
void PauseScreen::LoadContent() {
	...
	mainMenu = new UIButton(btnX, btnY + 0.2f, btnScaleX, btnScaleY, (void (GameScreen2D::*)()) &PauseScreen::MainMenuSelected, (void (GameScreen2D::*)(float, float)) &PauseScreen::MainMenuClicked, 
	...
	sounds = new UIButton(musicBtnX, musicBtnY + musicBtnHeight, musicBtnWidth, musicBtnHeight, (void (GameScreen2D::*)()) &PauseScreen::SoundsSelected, (void (GameScreen2D::*)(float, float)) &PauseScreen::SoundsClicked, 
				...
				new DrawableText2D(musicBtnX, musicBtnY + musicBtnHeight, 0.0f, 0.0f, 0.0f, "", font, 0.0f, T3Vector2(0.5f, 0.5f), T3Vector4(1,1,1,1), false), (void (GameScreen2D::*)()) &PauseScreen::SoundsDeselected, this);
