...
public:
	...
	Mesh* LoadQuadTexCoordCol(void* callerID, Vector2 scale, Vector2 texCoord, T3Vector4 colour); //NX 01/11/2012
	...
	//Generates a coloured quad, going from -1 to 1 on the x and z axis, with adjustable texture coords.
	void UnloadQuadTexCoordCol(void* callerID, Vector2 scale, Vector2 texCoord, T3Vector4 colour); //NX 01/11/2012
	// Generates Circle/Cone/Cylinder meshes with subdivs segments to approximate curvature
