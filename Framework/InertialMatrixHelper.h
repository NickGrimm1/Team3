...
public:
	...
	static T3Matrix4 createSphereInertial(float mass, float radius) {
		float I = 0.4f*mass*radius*radius;
		float elements[] = {I, 0, 0, 0, 0, I, 0, 0, 0, 0, I, 0, 0, 0, 0, 1};
		return T3Matrix4(elements);
	}

	static T3Matrix4 createSphereInvInertial(float mass, float radius) {
		float I = 2.5f/(mass*radius*radius);
		float elements[] = {I, 0, 0, 0, 0, I, 0, 0, 0, 0, I, 0, 0, 0, 0, 1};
		return T3Matrix4(elements);
	}

	static T3Matrix4 createCuboidInertial(float mass, float width, float height, float depth) {
	...
	static T3Matrix4 createCuboidInvInertial(float mass, float width, float height, float depth) {
	...
	static T3Matrix4 createImmovableInvInertial() {
